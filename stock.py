...
def plot_supertrend_and_fibonacci(stock_symbol):
    ...
    data = yf.download(stock_symbol, start='2023-01-01', end='2024-07-30')
...
st.sidebar.image('borsa.jpg',width=250)
...
if islemturu=='Nasdaq':
    NASDhissesec=st.sidebar.selectbox('Borsa Seçiniz', ('Apple', 'Microsoft', 'Amazon', 'Alphabet (Google)', 'Meta (Facebook)', 'Tesla', 'NVIDIA', 'PayPal', 'Intel', 'Comcast',
        ...
        'Baidu', 'Monster Beverage', 'Align Technology', 'Cadence Design Systems', 'Atlassian', 'OReilly Automotive', 'PACCAR', 'Xcel Energy', 'Kraft Heinz', 'Skyworks Solutions'
        , 'Altimeter Growth'))
    ...
    NASDhissesec=senetler[NASDhissesec]
    secim=NASDhissesec
    ...
    senetler = {'Marathon Digital Holdings': 'MARA',
